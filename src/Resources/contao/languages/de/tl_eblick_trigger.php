...
$GLOBALS['TL_LANG']['tl_eblick_trigger']['log'] = ['Log', 'Trigger-Log für ID%s anzeigen.'];
$GLOBALS['TL_LANG']['tl_eblick_trigger']['reset'] = ['Reset', 'Trigger-Log für Trigger ID%s zurücksetzen.'];
...
$GLOBALS['TL_LANG']['tl_eblick_trigger']['simulate'] = ['Simulieren', 'Abarbeitung von Trigger ID%s simulieren (ohne Aktionen auszuführen).'];
