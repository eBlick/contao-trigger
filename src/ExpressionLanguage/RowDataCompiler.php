...
{
    /**
     * Precompile an expression for row-based data with each column name being a
     * variable. Use the returned closure like $return($rowData) with $rowData being
     * an associative array that has $columnNames' values as keys. The closure
    ...
    public function compileRowExpression(string $expression, array $columnNames): \Closure
    {
        ...
        return static fn ($rowData): bool => true === @eval('return '.$compiledExpression.';');
    }
}
